...
<html>
<head>
    <title>How to get started with RequireJS</title>
...
<div id="wrapper">
    ...
    <div id="nav" class="mono">
        ...
        <ul>
            <li class="version">2.1.11 Docs (<a href="https://github.com/jrburke/requirejs/wiki/Upgrading-to-RequireJS-2.1">upgrade info</a>)</li>
...
<p>Once you are finished doing development and want to deploy your code for your end users, you can use the <a href="optimization.html">optimizer</a> to combine the JavaScript files together and minify it. In the example above, it can combine main.js and helper/util.js into one file and minify the result.</p>
    ...
    <div id="footer" class="mono">
        <span class="line">Latest Release: <a href="http://requirejs.org/docs/download.html">2.1.11</a></span>
